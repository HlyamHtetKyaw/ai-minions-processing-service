...
public record BalancedSyncJobMessage(
		...
		@JsonProperty("originalVideoSrtStorageUrl") String originalVideoSrtStorageUrl,
		@JsonProperty("originalVideoSrtS3Key") String originalVideoSrtS3Key,
		@JsonProperty("voiceOverSrtStorageUrl") String voiceOverSrtStorageUrl,
		@JsonProperty("voiceOverSrtS3Key") String voiceOverSrtS3Key,
